...
VALUES
    (1, 11, '보온무운', '대기', '제에에ㅔ목', 123456, 10, '2024-12-01', '2024-12-12'),
    (1, 11, '보온무운', '승인', '제에에ㅔ목', 123456, 10, '2024-12-02', '2024-12-12'),
    (1, 11, '보온무운', '승인', '제에에ㅔ목', 6578657, 10, '2024-12-03', '2024-12-12'),
    (1, 11, '보온무운', '승인', '제에에ㅔ목', 435376, 10, '2024-12-04', '2024-12-12'),
    (1, 10, '보온무운', '승인', '제에에ㅔ목', 2345755, 10, '2024-12-05', '2024-12-12'),
    (1, 10, '보온무운', '승인', '제에에ㅔ목', 3246, 10, '2024-12-06', '2024-12-12'),
    ...
    (1, 9, '보온무운', '대기', '제에에ㅔ목', 123456, 10, '2024-12-10', '2024-12-12'),
    (1, 9, '보온무운', '대기', '제에에ㅔ목', 123456, 10, '2024-12-11', '2025-01-12'),
    (1, 9, '보온무운', '승인', '제에에ㅔ목', 213424, 10, '2024-04-12', '2024-12-12'),
    (1, 9, '보온무운', '승인', '제에에ㅔ목', 1234544356, 10, '2024-12-13', '2024-12-12'),
    (1, 9, '보온무운', '승인', '제에에ㅔ목', 12531234, 10, '2024-12-14', '2024-12-12'),
    (1, 11, '보온무운', '대기', '제에에ㅔ목', 123456, 10, '2024-12-15', '2024-12-12'),
    (1, 11, '보온무운', '대기', '제에에ㅔ목', 123456, 10, '2024-12-16', '2024-12-12'),
    (1, 10, '보온무운', '대기', '제에에ㅔ목', 123456, 10, '2024-12-17', '2024-12-12'),
    (1, 9, '보온무운', '대기', '제에에ㅔ목', 123456, 10, '2024-12-18', '2024-12-12')
;
...
SELECT city_id FROM package  WHERE user_id = 9;
...
INSERT INTO package (city_id, user_id, package_content, package_status, package_title, package_cost, package_maxpeople, package_start_day, package_end_day)
VALUES
    (11, 9, '보온무운', '미승인', '제에에ㅔ목', 13456, 10, '2024-12-01', '2024-12-12'),
    (16, 9, '보온무운', '승인', '제에에ㅔ목', 12456, 10, '2024-12-02', '2024-12-12'),
    (4, 9, '보온무운', '승인', '제에에ㅔ목', 65657, 10, '2024-12-03', '2024-12-12'),
    (22, 9, '보온무운', '승인', '제에에ㅔ목', 43376, 10, '2024-12-04', '2024-12-12'),
    (4, 9, '보온무운', '승인', '제에에ㅔ목', 235755, 10, '2024-12-05', '2024-12-12'),
    (30, 9, '보온무운', '승인', '제에에ㅔ목', 32326, 10, '2024-12-06', '2024-12-12')
;