...
public class AipageServiceImpl implements AipageService {
    ...
    public List<Question> getQuestions() {
        ...
        questions.add(new Question("2. 나의 짐 챙기는 스타일은?", "여행가서 어떤 일이 생길지 몰라! 내가 우리 여행 바리바리 바리스타다!", "짐이 너무 많아도 문제야~ 필요한 것만 딱 챙겨가야지!"));
        questions.add(new Question("3. 내 눈앞에 보였으면 하는 풍경은??", "답답한 도시를 벗어나~ 자연 풍경이 보여야 하지 않겠어?!", "다양한 문화를 품고 있는 멋진 도시 한번 구경해보고 싶어."));
        questions.add(new Question("4. 사고 싶은 물건이 너무 많은데..?", "뭐가 문제야! 여행 왔는데 사고 싶은 거 다 사야지 FLEX~", "그래도 필요한 물건만 살 거야"));
